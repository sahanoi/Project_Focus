    ...
    return (
        <AnimatePresence>
            {newAchievement && (
                ...
                >
                    <div
                        className={`flex items-center gap-4 p-4 rounded-2xl border-2 shadow-xl ${TIER_COLORS[newAchievement.tier].bg} ${TIER_COLORS[newAchievement.tier].border} ${TIER_COLORS[newAchievement.tier].glow}`}
