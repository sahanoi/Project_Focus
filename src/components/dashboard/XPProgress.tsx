...
export default function XPProgress({ stats }: XPProgressProps) {
    ...
    return (
        <div className="flex items-center gap-3 bg-white/80 dark:bg-night-surface/80 rounded-lg px-4 py-2 border border-[#E6DDF2] dark:border-night-border shadow-sm h-10 w-full max-w-sm ml-auto backdrop-blur-sm transition-colors">
            {/* Level Badge */}
            ...
            <div className="flex-1 flex flex-col justify-center gap-1">
                ...
                <div className="h-1.5 w-full bg-[#E6DDF2] dark:bg-night-bg rounded-full overflow-hidden border border-primary/10 dark:border-primary/20 relative transition-colors">
                    <div
