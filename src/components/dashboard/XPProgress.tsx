...
export default function XPProgress({ stats }: XPProgressProps) {
    ...
    return (
        <button
            ...
            className="flex items-center gap-3 bg-surface-dark/80 dark:bg-night-surface/80 rounded-lg px-4 py-2 border border-[#D4C8E8] dark:border-night-border h-10 w-full max-w-sm ml-auto transition-colors cursor-pointer hover:bg-black/5 dark:hover:bg-primary/10 group"
        >
            {/* Level Badge */}
            <div className="flex flex-col leading-none">
                ...
                <span className="text-sm font-black text-dark dark:text-night-text transition-colors group-hover:text-primary-dark dark:group-hover:text-primary-light">{level}</span>
            </div>
