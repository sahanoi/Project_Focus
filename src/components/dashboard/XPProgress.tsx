...
export default function XPProgress({ stats }: XPProgressProps) {
    ...
    return (
        <button
            ...
            className="flex items-center gap-3 bg-surface-dark/80 dark:bg-night-surface/80 rounded-lg px-4 py-2 border border-[#D4C8E8] dark:border-night-border shadow-sm h-10 w-full max-w-sm ml-auto backdrop-blur-sm transition-all cursor-pointer hover:bg-black/5 dark:hover:bg-white/5 group active:scale-[0.98]"
        >
            {/* Level Badge */}
