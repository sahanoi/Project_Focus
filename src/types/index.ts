...
export const HABIT_TEMPLATES: Record<HabitCategory, HabitTemplate[]> = {
    ...
    fitness: [
        ...
        { name: 'Gym Session 🏋️', icon: '🏋️', type: 'regular', category: 'fitness', color: '#14B8A6', schedule: { type: 'weekly', daysOfWeek: [1, 2, 4, 5] } },
    ...
    productivity: [
        { name: 'Morning Routine ☀️', icon: '☀️', type: 'regular', category: 'productivity', color: '#F59E0B', schedule: { type: 'daily' } },
    ...
    mindfulness: [
        { name: 'Meditate 🧘‍♂️', icon: '🧘‍♂️', type: 'numerical', category: 'mindfulness', color: '#14B8A6', schedule: { type: 'daily' }, goalValue: 15, unit: 'min', dailyTarget: 5 },
    ...
    creativity: [
        ...
        { name: 'Write / Blog ✍️', icon: '✍️', type: 'numerical', category: 'creativity', color: '#2563EB', schedule: { type: 'daily' }, goalValue: 500, unit: 'words' },
    ],
    other: [
